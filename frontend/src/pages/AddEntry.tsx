...
export default function AddEntry() {
  ...
  const recommendedIso = serviceIso ? computeRecommendedServiceDate(serviceIso) : null;
  ...
  return (
    <div>
      ...
      <form className="card" onSubmit={onSubmit}>
        ...
        {/* Recommended Service Date — auto-generated, read-only. */}
        <label className="field-label">Recommended Service Date (auto)</label>
        <div className="field-readonly">
          {recommendedIso ? formatDisplay(recommendedIso) : "Set a Service Date first"}
        </div>
        <div className="field-hint">
          Automatically set to 12 months after the Service Date. Updates whenever
          you change the Service Date. (Kept separate from the MOT Due Date.)
        </div>
